...
function putMenu(){
  ...
  if(page=="ffc.html") sel=1;
  if(page=="matrix.html") sel=2;
  if(page=="mrnback.html") sel=3;
  if(page=="face.html") sel=4;
...
function changeApp(){
  ...
  if(go==1) window.location.href="ffc.html";
  if(go==2) window.location.href="matrix.html";
  if(go==3) window.location.href="mrnback.html";
  if(go==4) window.location.href="face.html";
